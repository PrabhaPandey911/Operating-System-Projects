...
// void compare_thread(struct thread* t)
// {
...
// {
//   th->priority = PRI_MAX - (((int64_t)th->recent_cpu)*f/4) - (((int64_t)th->nice_no)*2)/f;
// }
...
// //MLFQS 
// int recal_priority(int priority)//added
// {
...
//mlfqs
// //added to calculate the load avg 
// void compute_load_avg()
// {
//   if(strcmp(thread_current()->name,"idle")==0)
//   {
//     load_avg=((((59*(int64_t)load_avg)/f)*f)/60)+(((list_size(&ready_list)*f)*f)/60);
//   }
//   else
//   {
//     load_avg=((((59*(int64_t)load_avg)/f)*f)/60)+((((list_size(&ready_list)+1)*f)*f)/60);
//   }
// }
// //added to calculate the recent cpu of specified thread
// void compute_recent_cpu(struct thread* th)
// {
//   int64_t x=(((int64_t)load_avg*2)/f);
//   int64_t y=(((int64_t)x)*f)/(x+1);
//   int64_t z=((int64_t)y*th->recent_cpu)/f;
//   z=z+th->nice_no;
//   th->recent_cpu=z;
// }
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  //   else
  //     compute_recent_cpu(thread_current());
